...
```
bash <(curl -s https://raw.githubusercontent.com/tsunamyh/wizwizxui-timebot_1/main/wizwiz.sh)
```
...
```
bash <(curl -s https://raw.githubusercontent.com/tsunamyh/wizwizxui-timebot_1/main/update.sh)
```
